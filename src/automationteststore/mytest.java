...
import org.openqa.selenium.devtools.v128.filesystem.model.BucketFileSystemLocator;
...
//		driver.get(LogoutURl);
	...
	public void AddItemToThecart() throws InterruptedException {
		...
		if (LiItem > 0) {
			...
			Assert.assertEquals(ActualResult, ExpectedResult, "hi");
			...
			Assert.assertEquals(ActualValueForCheckOut, ExpectedValueForCheckOut, "hiiii");
		}
	}
}
